...
public class LanguageModel {
     ...
     * value. Generating texts from this model multiple times with the same seed
     * value will produce the same random texts. Good for debugging.
     */
    ...
    /**
     * Constructs a language model with the given window length. Generating
     * texts from this model multiple times will produce different random texts.
     * Good for production.
     */
     ...
     * of size numberOfLetters doesn't appear as a key in Map, we generate no
     * text and return only the initial text.
